...
if volba == "Žebříček hráčů 🏆":
    ...
    with c_form:
        ...
        with st.form("dlouhodobe_tipy_form"):
            ...
            tip_cesko = st.selectbox("Kam až dojde český tým?": "https://crests.football-data.org/798.svg", options=faze_options, index=faze_options.index(stary_cesko), disabled=dlouhodobe_disabled)
